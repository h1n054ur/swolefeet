...
class ConfigureMenu(BaseMenu):
    def show(self):
        """Entry point to show the configure menu."""
        clear_screen()
        print_header("Configure Phone Number", "⚙️")
        self._handle_configure_flow()

    def _handle_configure_flow(self):
        """Handle the configuration flow for phone numbers."""
        # Get active numbers
